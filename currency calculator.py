#we will build currency calculator in python
import tkinter as tk  #it is used For Graphical Interface
from forex_python.converter import CurrencyRates

common_currencies=['USD','EUR','JPY','CAD','AUD','CHF','NZD']
...
class CurrencyConverter:
    ...
    def __init__(self) :
        self.root=tk.Tk()
        self.root.title("Currency Converter By Swayam")
    ...
    def convert_currency(self):
        try:
            ...
            self.result_label.config(text="Pls Enter a Valid Number Or Value!.")
        except Exception:
